...
with open('script_map.py', 'wt') as f:
    ...
    f.write('# generated by unicode_script.py\n')
    ...
    f.write('def script_str(seq):\n')
    f.write('    conv = [ord(c) for c in seq]\n')
    f.write('    result = numpy.searchsorted(CODEPOINT, conv)\n')
    f.write('    return (SCRIPT[r] for r in result)\n')
